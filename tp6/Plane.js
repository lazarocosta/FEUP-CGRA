...
/*function Plane(scene, nrDivs) {
	...
	this.minS = -0.5;
	this.maxT = 0.5;
	this.patchLengthS = 1.0 / nrDivs;
	this.patchLengthT = 1.0 / nrDivs;
...
function Plane(scene, nrDivs, minS, maxS, minT, maxT) {
	...
	// nrDivs = 1 if not provided
	nrDivs = typeof nrDivs !== 'undefined' ? nrDivs : 1;
	minS = typeof minS !== 'undefined' ? minS : -0.5;
	maxS = typeof maxS !== 'undefined' ? maxS : 0.5;
	minT = typeof minT !== 'undefined' ? minT : -0.5;
	maxT = typeof maxT !== 'undefined' ? maxT : 0.5;
